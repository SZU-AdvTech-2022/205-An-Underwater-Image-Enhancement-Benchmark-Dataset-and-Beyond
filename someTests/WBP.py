...
img5: 动态阈值算法
'''
img = cv2.imread('test_real/600_img_.png')
...
cv2.imwrite('WBP-test1.png',img1)
cv2.imwrite('WBP-test2.png',img2)
cv2.imwrite('WBP-test3.png',img3)
cv2.imwrite('WBP-test4.png',img4)
cv2.imwrite('WBP-test5.png',img5)